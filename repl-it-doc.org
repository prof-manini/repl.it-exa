...
create table Person (              -- nomi delle tabelle "capitalized"
    ...
    code char[5] not null unique   -- ultima riga SENZA virgola!
);
#+end_src
...
(name, code)           -- nomi delle colonne
values
('Linus', '123-L'),    -- valori, nelleo stesso ordine
('Richard', '444-R'),  -- in cui sono state specificate
('Bob', '666-B');      -- le colonne!
#+end_src
...
#+end_src
    ...
    E questo è un tipico risultato (il sepratore di colonne dipende da
